...
parser.add_argument("--split", type=str, default='stereo', help='eigen or stereo split')  # stereo test
#parser.add_argument("--split", type=str, default='eigen', help='eigen or stereo split')     # eigen test
...
def convert_disps_to_depths_stereo_unos(gt_disparities, pred_disparities):
    gt_depths = []
    pred_depths = []
    pred_disparities_resized = []
...
def main():
    ...
    if args.split == 'eigen':
        ...
        gt_depths, pred_depths, pred_disparities_resized = convert_disps_to_depths_stereo_unos(gt_disparities, pred_depths)
    ...
    with open(args.output_dir + 'depth_result.txt', 'a') as f:
        f.write('evaluating ' + args.pred_file + '...\n')
        f.write("{:>10}, {:>10}, {:>10}, {:>10}, {:>10}, {:>10}, {:>10}, {:>10}\n".format('abs_rel', 'sq_rel', 'rms',
                                                                                          'log_rms', 'd1_all', 'a1',
                                                                                          'a2', 'a3'))
        f.write(
